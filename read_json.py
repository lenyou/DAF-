...
def generate_Pic(info):
    ...
    # print ("consumeing time: %f"%(toc-tic))
    # start_row = last_row
...
# print (len(train_pub_dict))
# for key in train_pub_dict:
#     values = train_pub_dict[key]
#     generate_Pic(values)
#     # print (values)
#     # print (key)
#     # break
...
# print (train_author_dict.items())

# train_author_pd = pd.read_json(train_author_path).T

# for rowid,row in train_author_pd.iterrows():
#     print (row) 
#     break
# print (train_author_pd.shape)

# train_pub_pd = pd.read_json(train_pub_path)

# print (train_author_pd,train_pub_pd)
